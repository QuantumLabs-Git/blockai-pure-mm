...
function readTokensFromCSV(): string[] {
  try {
    const csvFilePath = path.resolve(__dirname, 'temp/tokens_warmup_1748089069394.csv');
...
function readWalletsFromCSV(): string[] {
  try {
    const csvFilePath = path.resolve(__dirname, 'temp/wallets_warmup_1748089069394.csv');
