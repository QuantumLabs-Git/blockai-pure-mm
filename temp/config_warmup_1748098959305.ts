...
function readTokensFromCSV(): string[] {
  try {
    const csvFilePath = path.resolve(__dirname, 'temp/tokens_warmup_1748098959305.csv');
...
function readWalletsFromCSV(): string[] {
  try {
    const csvFilePath = path.resolve(__dirname, 'temp/wallets_warmup_1748098959305.csv');
